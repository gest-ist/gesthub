...
home-about-body-1 = Somos un grupo de estudiantes del IST que promueve el convívio através de todo tipo de juegos, desde juegos de tablero y juegos narrativos, a juegos de cartas, videojuegos, y más. Organizamos eventos como las Game Nights, Campañas y One-Shots de TTRPGs, torneos, y otras actividades a lo largo del año. Además de eso, buscamos fomentar uma comunidad acogedora e inclusiva, en la cual todos son bienvenidos a compartir el gusto por los diversos juegos. Únete a la nuestra comunidad en Discord y siguenos en Instagram para estar informado de nuestros eventos! Si tienes alguna duda, contactanos por mail o por nuestras redes sociales.
...
collection-about =
  Aquí está la nuestra ludoteca! Aquí puedes ver todos los juegos y material de TTRPG que tenemos disponibles.

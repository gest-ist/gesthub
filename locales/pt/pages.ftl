...
home-recruitment-title = Recrutamento
home-recruitment-body =
  Estamos sempre à procura de novos membros para entrarem na nossa equipa, participarem nas nossas atividades e ajudarem a organizar eventos. Se quiseres participar, preenche o formulário.
home-recruitment-form = Preencher formulário de recrutamento
home-workshop-title = Workshop "A tua Primeira Personagem"
home-workshop-body = Vamos realizar um Workshop para te ajudar a criar a tua primeira personagem. Vai decorrer numa das duas primeiras semanas de aulas dependendo do dia em que mais pessoas se podem juntar. Preenche o formulário para indicares que queres participar. 
home-workshop-forms = Inscrever-me no Workshop "A tua Primeira Personagem"
...
partners-title = GEST — Parceiros
partners-description = Parceiros do GEST.
partners-intro =
  O GEST agradece aos parceiros que tornam possível a realização das nossas atividades e iniciativas.
  Conhece as entidades que apoiam a nossa comunidade e ajudam a levar mais jogos e eventos ao IST.
...
rpgist-description = Festival de RPG organizado pelo GEST no Instituto Superior Técnico.
rpgist-hero-alt = Banner do RPGIST
rpgist-about-body =
  O RPGIST é um evento dedicado aos jogos de roleplay, pensado para reunir jogadores, mestres e entusiastas em torno de mesas de fantasia, ficção científica, horror e muito mais.
  A edição de 2026 traz experiências, sessões, workshops e convívio em torno da comunidade de RPG do IST.
rpgist-tables-left-alt = Mesas do RPGIST preparadas para sessões
rpgist-characters-right-alt = Jogadores do RPGIST a preparar personagens
rpgist-setup-alt = Montagem do evento e zona de jogo do RPGIST
rpgist-setup-caption = Um espaço para novos e experientes jogadores reunirem-se em torno da próxima campanha.
rpgist-dice-alt = Dados e material de jogo do RPGIST na mesa
rpgist-dice-caption = Dados, mapas e histórias prontas para começar.
rpgist-community-alt = Comunidade do RPGIST e mestre de jogo no evento
rpgist-community-cta = Uma comunidade acolhedora para jogadores, mestres e curiosos.
